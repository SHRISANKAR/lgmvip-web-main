...
myForm.addEventListener("submit", (e) =>{
   ...
   e_row.classList.add("details","enroll", "row");
   e_row.id="std_row";
   ...
   e_data.classList.add("details","e_data", "coloumn");
   ...
   e_name.id="e_name";
   e_name.innerText = "Name: " + document.getElementById("name").value;
//    e_name.innerText  = "nName: "
   ...
   for(i=0 ; i<e_radio.length ; i++){
       if(e_radio[i].checked){
            ...
            e_gender.innerHTML = "Gender: "+ e_radio[i].value;
       }
   }
   ...
   e_email.id="e_email";
   e_email.innerText = "Email: "+document.getElementById("email").value;
   ...
   e_link.innerText = "Website: "+document.getElementById("website").value;
